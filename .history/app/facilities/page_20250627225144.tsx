...
export default function FacilitiesPage() {
  const facilities = [
    ...
    {
      title: "Oven",
      description: "This device is used to measure the refection of light from earth's surface. It consists of two pyranometers, one facing up towards the sky and one facing down towards the surface for its setup.",
      image: "/facilities/Albedometer_0.jpg?height=250&width=400&text=HPC+Cluster",
      externalLink: "https://iitpkd.ac.in/facilities/albedometer",
      contact: "jthin@iitpkd.ac.in | 04923226470",
      location: "Workshop - 8",
