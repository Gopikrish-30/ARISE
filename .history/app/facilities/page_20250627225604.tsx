...
export default function FacilitiesPage() {
  const facilities = [
    ...
    {
      title: "Pressure Ageing Vessel",
      description: "It is used to simulate the accelerated ageing of bitumen and bituminous binders after 5 to 10 years. The sample is exposed to high pressure and temperature for 20 hours, to simulate the effect of a long time oxidative ageing by verifying the penetration and softening point characteristics",
      image: "/facilities/PAV.jpg?height=250&width=400&text=HPC+Cluster",
