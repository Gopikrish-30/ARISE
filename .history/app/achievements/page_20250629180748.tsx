        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {[
              ...
              { number: "15+", label: "Patents Filed", icon: Award, link: "/research" },
              { number: "100+", label: "Publications", icon: Award, link: "/research/journals" },
              { number: "₹2Cr+", label: "Research Funding", icon: Award, link: "/research" },
            ].map((stat, index) => (
              <Link
                key={index}
