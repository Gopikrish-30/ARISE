  ...
  const phdScholars = [
    {
      ...
      bio: "Working on novel architectures for medical image analysis using deep learning techniques. His research focuses on developing automated diagnostic systems for early disease detection.",
      email: "amit.patel@iitpkd.ac.in",
      phone: "+91 9876543210",
      office: "Room 301, Research Block",
      supervisor: "Dr. Rajesh Kumar",
      iitProfile: "https://iitpkd.ac.in/students/amit-patel",
      publications: 5,
      conferences: 8,
    },
    {
      name: "Sneha Reddy",
      role: "PhD Scholar",
      interests: ["Natural Language Processing", "Machine Learning", "Multilingual AI"],
      joiningDate: "January 2022",
      expectedCompletion: "December 2025",
      bio: "Research focuses on multilingual NLP and cross-lingual transfer learning. She is developing novel approaches for low-resource language processing.",
      email: "sneha.reddy@iitpkd.ac.in",
      phone: "+91 9876543211",
      office: "Room 302, Research Block",
      supervisor: "Dr. Priya Sharma",
      iitProfile: "https://iitpkd.ac.in/students/sneha-reddy",
      publications: 3,
      conferences: 6,
    },
  ]
  ...
  const ScholarCard = ({ scholar, showCompletion = true }: { scholar: any; showCompletion?: boolean }) => (
    <Card className="group overflow-hidden hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 border-0 shadow-lg">
      <CardContent className="p-6">
        ...
        <p className="text-sm text-gray-600 mb-3">Supervisor: {scholar.supervisor}</p>
