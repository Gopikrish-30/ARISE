    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <div
          ...
          style={{
            backgroundImage: `url('/images/hero.jpg?height=1080&width=1920&text=IIT+Palakkad+Campus')`,
          }}
        />
            ...
            <div className={`space-y-8 ${isVisible ? "animate-fade-in-up" : "opacity-0"}`}>
              ...
              <div className="space-y-4">
                <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-white leading-tight drop-shadow-lg">
                  ASPIRE
                  <span className="block text-blue-300">ADVANCING SUSTAINABLE PAVEMENT INNOVATION AND RESEARCH ENSEMBLE</span>
