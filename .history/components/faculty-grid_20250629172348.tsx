  ...
  const faculty = [
    {
      ...
      image: "/images/faculty-1.png?height=300&width=300&text=Dr.+Veena+Venudharan",
      interests: [
        "Pavement material",
        "Pavement design",
      ...
      education: [
        ...
        "B.Tech in Civil Engineering, University of Calicut",
      ],
          ...
          <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="grid md:grid-cols-3 gap-6">
              <div className="md:col-span-1">
                <div className="bg-gradient-to-br from-blue-100 to-blue-200 rounded-lg h-64 overflow-hidden mb-4">
                  <img
              ...
              <div className="md:col-span-2">
                ...
                <div className="space-y-4">
                  ...
                  {/* Removed contact info grid section here */}
