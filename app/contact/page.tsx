          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="space-y-6 mb-8">
                <div className="flex items-start group cursor-pointer hover:bg-gray-50 p-4 rounded-lg transition-colors">
                  <MapPin className="w-6 h-6 text-blue-600 mr-4 mt-1 flex-shrink-0 group-hover:scale-110 transition-transform" />
                  <div>
